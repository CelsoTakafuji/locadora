            ...
            if (isset($_SESSION['logado_cliente']) AND isset($_POST['comentou']) == 'ok'):
                ...
                if (!isset($mensagem)):
                    ...
                    if (cadastrarComentario($dados)):
                        ...
                        echo "<div class='sucesso'>Comentário cadastrado, seu comentário estará disponível assim que for aprovado por nós !</div><br />";
                        ?>
                        <a href="<?php echo BASE; ?>/detalhes/filme/<?php echo $filme->filmes_slug; ?>">Voltar</a>
                        <?php
                    else:
