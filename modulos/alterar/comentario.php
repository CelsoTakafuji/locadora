<?php
include_once '../../functions/iniSis.php';
include_once '../../functions/functions.php';
?>

<link rel="stylesheet" media="screen" type="text/css" href="<?php echo BASE; ?>/css/edit.css" />
<script type="text/javascript" src="<?php echo BASE; ?>/js/editar_comentario_jquery.js"></script>
