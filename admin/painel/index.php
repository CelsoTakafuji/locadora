...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="topNav">
            <div class="fixed">
                <div class="wrapper">
                    ...
                    <div class="userNav">
                        <ul>
                            <li class="dd"><img src="images/icons/topnav/messages.png" alt="" /><a href="?p=comentarios" title=""><span>Comentários</span><span class="numberTop"><?php echo contar('comentarios'); ?></span></a></li>
        ...
        <div id="header" class="wrapper">
            ...
            <div class="middleNav">
                <ul>
                    <li class="iMes"><a href="?p=noticias" title=""><span>Notícias</span></a><span class="numberMiddle"><?php echo contar('noticias'); ?></span></li>
                    <li class="iUser"><a href="?p=clientes" title=""><span>Lista Clientes</span></a></li>
                </ul>
            </div>
            <div class="fix"></div>
        </div>
        ...
        <div class="wrapper">
            ...
            <div class="leftNav">
                <ul id="menu">
                    <li class="dash"><a href="<?php echo BASE; ?>/admin/painel/" title="" class="active"><span>Painel</span></a></li>
        ...
        <div id="footer">
            <div class="wrapper">
                <span><?php echo SITENAME." ".SITEANO; ?> - Todos direitos reservados</span>
            </div>
        </div>
