                        ...
                        <table width="780" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                while ($fm->valid()):
                                    ...
                                    <!--LISTAGEM DOS FILMES DO MES -->
                                    <tr class="tabela_filmes_locados">
                                        <td><img src="<?php echo BASE . "/" . $fm->current()->filmes_foto ?>" width="45" height="35" /></td>
            ...
            <div class="wrapper">
                <ul>
                    ...
                    while ($lan->valid()):
                        ?>
                        <li>
                            <a href="<?php echo BASE; ?>/detalhes/<?php echo $lan->current()->filmes_slug; ?>"><img src="<?php echo BASE . "/" . $lan->current()->filmes_foto; ?>" width="80" height="90" alt="<?php echo $lan->current()->filmes_slug; ?>"/></a>
                            <br />
    ...
    try {
        ...
        if (empty($filmes)):
            ...
            <table width="780" cellspacing="0" id="tabela_meus_filmes">
                ...
                <tbody>
                    ...
                    while ($f->valid()):
                        ...
                        ?>
                        <tr class="tabela_filmes_locados">
                            <td><img src="<?php echo BASE . "/" . $filmes->filmes_foto ?>" width="45" height="35"/></td>
                            <td><?php echo $filmes->filmes_nome ?></td>
                            <td> R$ <?php echo number_format($filmes->filmes_preco, 2, ",", "."); ?></td>
                            <td align="center"><img src="<?php echo BASE; ?>/imagens/delete.png" /></td>
                        </tr>
            ...
            <tr><td colspan="1" class="total_meus_filmes">Total: R$ <?php echo number_format($totalLocacao, 2, ",", "."); ?></td>
                ...
                <td colspan="2" class="total_meus_filmes"><a href="<?php echo BASE; ?>">Continuar Locando</a></td>
            </tr>
        <tbody>
    </table>
</div>
