    ...
    if (!isset($_SESSION['logado_cliente'])):
        ...
        <div id="logar_cliente">
            ...
            <div id="logar">
                ...
                <form action="<?php echo BASE . basename($_SERVER['REQUEST_URI']); ?>" method="post">
            ...
            <div id="cadastrar">
                ...
                <p id="mensagem_cadastrar">
                    ...
                    Qualquer dúvida, entre em contato conosco através do e-mail: <?php echo MAILUSER; ?><br /><br />
                    <a href="<?php echo BASE; ?>/cadastrar">CADASTRAR</a>
                </p>
            </div>
        </div>
        <?php
