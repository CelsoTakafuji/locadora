        ...
        if (empty($filmes)):
            ...
            <div id="foto_descricao">
                ...
                <div id="foto_detalhes_filme">
                    <img src="<?php echo BASE . "/" . $filmes->filmes_foto_descricao; ?>" />
                    ...
                    <div id="botao_locar">
                        ...
                        if (!empty($locado)):
                            ?>
                            <img src="<?php echo BASE; ?>/imagens/indisponivel_detalhes.jpg" />
                        <?php else: ?>                      
                            <a href="<?php echo BASE; ?>/meus_filmes/filme/<?php echo $filmes->filmes_slug; ?>"><img src="<?php echo BASE; ?>/imagens/locar_detalhes.jpg" /></a>
                        <?php endif; ?>
                    </div>
                        ...
                        while ($s->valid()):
                            ...
                            <div class="filmes_categoria">
                                ...
                                if (!empty($verificaLocado)):
                                    ?>
                                    <div class="faixa_locado"><img src="<?php echo BASE; ?>/imagens/faixa.png" /></div>
                                    <?php
                                endif;
                                /* VERIFICA SE FILME ESTA LOCADO E COLOCA UMA FAIXA EM CIMA DA FOTO DO FILME */
                                ?>
                                ...
                                <div class="foto_filme_categoria"><img src="<?php echo BASE . "/" . $s->current()->filmes_foto; ?>" /></div>
                                <div class="dados_filme">
                                    ...
                                    <a href="<?php echo BASE; ?>/detalhes/filme/<?php echo $s->current()->filmes_slug; ?>" class="bt_detalhes">Detalhes</a> | 
                                    <?php
                                    if (!empty($verificaLocado)):
                                        ?>
                                        Filme Locado
                                        ...
                                        if (isset($_SESSION['locar']) && array_key_exists($s->current()->filmes_id, $_SESSION['locar'])):
                                            ...
                                            ?>
                                            <a href="<?php echo BASE . "/" . $link; ?>" class="locar_filme">Locar Filme</a>
                                        <?php
                                        endif;
                                    endif;
                                    ?>
                ...
                <div id="comentarios">
                                ...
                                <div class="foto_cliente">  
                                    <?php if (!empty($l->current()->clientes_foto)) { ?>
                                        ...
                                        <?php if (!is_file($l->current()->clientes_foto)): ?>
                                            <img src="<?php echo BASE; ?>/fotos/clientes/sem_foto.jpg" />
                                        <?php else: ?>
                                            <img src="<?php echo BASE . "/" . $l->current()->clientes_foto; ?>" />
                                        <?php endif; ?>
                                    ...
                                    if (isset($_SESSION['logado_cliente'])):
                                        if (checkEdit($l->current()->clientes_id, $l->current()->comentarios_id)):
                                            ...
                                            if ($l->current()->clientes_id == $idCliente->clientes_id):
                                                ?>
                                                <a href="#" id="edit" data-id="<?php echo $l->current()->comentarios_id; ?>"><img src="<?php echo BASE; ?>/imagens/edit.png" /></a> | <a href="#" id="deletar_comentario" data-id="<?php echo $l->current()->comentarios_id; ?>"><img src="<?php echo BASE; ?>/imagens/delete.png" /></a>                                                         
                    ...
                    <div id="form_comentarios">
                        <?php if (isset($_SESSION['logado_cliente'])): ?>
                            <form action="<?php echo BASE; ?>/modulos/cadastrar/comentarios" method="post">
